...
weapon_data = {
    ...
    'sai': {'cooldown': 80, 'damage': 12, 'graphic': '../graphics/weapons/sai/full.png'}}
...
# upgrade rectangle dimensions
UPGRADE_RECT_WIDTH = 30
UPGRADE_RECT_HEIGHT = 10

# upgrade ratio
UPGRADE_RATIO = 1.3
UPGRADE_COST_RATIO = 1.4
# magic
magic_data = {
